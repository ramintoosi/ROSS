...
class Detected_Time_Dialog(QtWidgets.QDialog):
    def __init__(self, variables):
        ...
        self.setWindowTitle("Select Detected Time Data")
        self.label.setText("Select the variable containing detected time data:")
