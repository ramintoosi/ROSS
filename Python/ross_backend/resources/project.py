...
class Project(Resource):
    ...
    def get(self, name): # for loading project as default project  
        ...
        if proj:
            ...
            raw_proj = proj.raw#RawModel.find_by_project_id(user_id=user_id, project_id=proj.id)
            # if raw_proj:
            ...
            config_detect_proj = proj.config_detect  # ConfigDetectionModel.find_by_project_id(user_id=user_id, project_id=proj.id)  
            ...
            if config_detect_default:
                ...
                config_detect_default = ConfigDetectionModel(user_id=user_id, project_id=0, filter_type=config_detect_proj.filter_type,
                                 filter_order=config_detect_proj.filter_order, pass_freq=config_detect_proj.pass_freq,
                                 stop_freq=config_detect_proj.stop_freq, sampling_rate=config_detect_proj.sampling_rate, 
                                 thr_method=config_detect_proj.thr_method, side_thr=config_detect_proj.side_thr, 
                                 pre_thr=config_detect_proj.pre_thr, post_thr=config_detect_proj.post_thr, 
            ...
            if config_sort_default:
                ...
                config_sort_default = ConfigSortModel(user_id=user_id, project_id=0, max_shift=config_sort_proj.max_shift, histogram_bins=config_sort_proj.histogram_bins, num_peaks=config_sort_proj.histogram_bins, compare_mode=config_sort_proj.compare_mode, max_std=config_sort_proj.max_std, max_mean=config_sort_proj.max_mean, max_outliers=config_sort_proj.max_outliers, nu=config_sort_proj.nu, PCA_num=config_sort_proj.PCA_num, g_max=config_sort_proj.g_max,
                 g_min=config_sort_proj.g_min, u_lim=config_sort_proj.u_lim, error=config_sort_proj.u_lim, tol=config_sort_proj.tol, N=config_sort_proj.N, matching_mode=config_sort_proj.matching_mode, alpha=config_sort_proj.alpha, combination=config_sort_proj.combination, custom_template=config_sort_proj.custom_template, sorting_type=config_sort_proj.sorting_type, max_iter=config_sort_proj.max_iter)
            try:
    ...
    def post(self, name):
        ...
        if config_detect_default:
            config = ConfigDetectionModel(user_id = user_id, project_id=proj.id, filter_type=config_detect_default.filter_type,
                                 filter_order=config_detect_default.filter_order, pass_freq=config_detect_default.pass_freq,
                                 stop_freq=config_detect_default.stop_freq, sampling_rate=config_detect_default.sampling_rate, 
                                 thr_method=config_detect_default.thr_method, side_thr=config_detect_default.side_thr, 
                                 pre_thr=config_detect_default.pre_thr, post_thr=config_detect_default.post_thr, 
        ...
        if config_sort_default:
            config = ConfigSortModel(user_id = user_id, project_id=proj.id, max_shift=config_sort_default.max_shift, histogram_bins=config_sort_default.histogram_bins, num_peaks=config_sort_default.num_peaks, compare_mode=config_sort_default.compare_mode, max_std=config_sort_default.max_std, max_mean=config_sort_default.max_mean, max_outliers=config_sort_default.max_outliers, nu=config_sort_default.nu, PCA_num=config_sort_default.PCA_num, g_max=config_sort_default.g_max,
                 g_min=config_sort_default.g_min, u_lim=config_sort_default.u_lim, error=config_sort_default.error, tol=config_sort_default.tol, N=config_sort_default.N, matching_mode=config_sort_default.matching_mode,alpha=config_sort_default.alpha, combination=config_sort_default.combination, custom_template=config_sort_default.custom_template, sorting_type=config_sort_default.sorting_type, max_iter=config_sort_default.max_iter, run_sorting=config_sort_default.run_sorting, alignment=config_sort_default.alignment, filtering=config_sort_default.filtering)
            # config = copy.deepcopy(config_detect_default)
            # config.project_id = proj.id
        else:
